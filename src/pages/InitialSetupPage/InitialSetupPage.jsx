...
export default function InitalSetup() {
  ...
  const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NDhkZmJlMDcyNDlhNzQ3ODIwNjlkMDkiLCJpYXQiOjE2ODczNjQ3NjUsImV4cCI6MTY4NzQ1MTE2NX0.SYC466Ra-_MohmITlX2FlYDJ06pJ5_tLK0DrwGESlx4";
  ...
  return (
    <>
      <div
        ...
        style={openDrop1 ? { height: calcHeight } : null}
      ></div>
      <div className="container">
        <h1 className="title">Initial setup</h1>
        <div className="first_element inital_setup_element">
          <InitialSetupGraphic />
        </div>
            ...
            {({
              ...
              <Form onSubmit={handleSubmit}>
                <div className="inital_setup_form">
                  ...
                  <dialog
                    ref={avatarDialog}
                    className={openDrop1 ? "modal" : null}
                  >
                  ...
                  <Button txt="done" onClick={handleSubmitButtonClick}></Button>
                </div>
              </Form>
            )}
          </Formik>
