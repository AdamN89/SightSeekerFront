  ...
  return (
    <div className="App">
      <Routes>
        ...
        <Route path="/settings" element={token? <SettingsPage /> : <LandingPage />}/>
        <Route path="/features" element={token? <FeaturesPage /> : <LandingPage />}/>
        <Route path="/about" element={token? <AboutPage /> : <LandingPage />}/>
        <Route path="/initialsetup" element={token? <InitialSetupPage /> : <LandingPage />}/>
        <Route path="/home" element={token? <HomePage /> : <LandingPage />}/>
        <Route path="/spiner" element={<Loader />}/>
        <Route path="/friends" element={token? <FriendsPage /> : <LandingPage />}/>
        <Route path="/chat" element={token? <Chat /> : <LandingPage />}/>
        <Route path="/invitation" element={token? <ReceivedInvitation /> : <LandingPage />}/>
        <Route path="/travelplans" element={token? <TravelsPage /> : <LandingPage />}/>
      </Routes>
    </div>
  );
}
